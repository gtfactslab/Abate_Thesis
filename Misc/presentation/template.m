...
plot(xu3(1, :), xu3(2, :), 'b', 'LineWidth', 2)
plot(xo3(1, :), xo3(2, :), 'b', 'LineWidth', 2)
...
%matlab2tikz('emb2.tikz', 'width', '6cm', 'height', '4cm')
...
% Plot Cone Coresponding to Phi^e3
patch([xu_T3(2, 1), xu_T3(2, 1), xo_T3(2, 1)], ...
      [xo_T3(2, 1), xu_T3(2, 1), xo_T3(2, 1)], 'g', ...
            'FaceAlpha', .2, ...
            'LineWidth', 1, ...
            'HandleVisibility', 'off');
% Plot trajectory of embedding system that yeilds approximation    
plot(xu3(2, :), xo3(2, :), 'b', 'LineWidth', 2, 'HandleVisibility', 'off')
scatter(X0(2, 1), X0(2, 2),60,  'b', 'filled', ...
                'MarkerEdgeColor', 'k', ...
                'HandleVisibility', 'off');
scatter(xu_T3(2, 1), xo_T3(2, 1),60, 'b','filled', ...
                'MarkerEdgeColor', 'k', ...
                'HandleVisibility', 'off');

% Plot Diagnol of Embedding Space
plot([-1, 3], [-1, 3], 'k', 'LineWidth', 1.25)
...
%matlab2tikz('MM_ex_2.tikz', 'width', '6cm', 'height', '4cm')
