...
plot(timevec(1:disc:end), z_holder(1, 1:disc:end), 'Color', backup_traj_color, 'LineWidth', LW_backup_traj, 'HandleVisibility', 'off');
plot(timevec(1:disc:end), z_holder(2, 1:disc:end), 'Color', backup_traj_color, 'LineWidth', LW_backup_traj, 'DisplayName', 'RSO w/o Transform');
reach_set = patch([timevec(1:disc:end),fliplr(timevec(1:disc:end))], ...
                  [z_holder(1, 1:disc:end), fliplr(z_holder(2, 1:disc:end))], ...
                  'c', 'facealpha', 0.1, 'edgealpha', 0, 'HandleVisibility', 'off');


plot(timevec(1:disc:end), z_holderT(1, 1:disc:end), 'Color', backup_traj_color2, 'LineWidth', LW_backup_traj, 'HandleVisibility', 'off');
plot(timevec(1:disc:end), z_holderT(2, 1:disc:end), 'Color', backup_traj_color2, 'LineWidth', LW_backup_traj, 'DisplayName', 'RSO w/ Transform');
reach_set2 = patch([timevec(1:disc:end),fliplr(timevec(1:disc:end))], ...
                  [z_holderT(1, 1:disc:end), fliplr(z_holderT(2, 1:disc:end))], ...
                  'r', 'facealpha', 0.1, 'edgealpha', 0, 'HandleVisibility', 'off');

plot(timevec(1:disc:end), thing_sauce(1, 1:disc:end), 'Color', 'k', 'LineWidth', LW_backup_traj, 'DisplayName', 'Deterministic Trajectory');
...
matlab2tikz('sc_reach.tikz', 'width', '6cm', 'height', '4cm')
